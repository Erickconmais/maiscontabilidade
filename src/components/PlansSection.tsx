...
const PlansSection = () => {
  ...
  const plans = [{
    ...
    recommended: false,
    features: ["Contabilidade para MEI ou empresas iniciais", "Obrigações fiscais básicas", "Suporte via WhatsApp", "Emissão de notas fiscais", "Declarações anuais"]
  }, {
    id: "plus" as const,
    name: "Plus",
    price: "199",
    ...
    recommended: true,
    features: ["Tudo do plano Essencial", "Suporte prioritário", "Acompanhamento mais próximo", "Relatórios mensais", "Consultoria tributária básica", "Atendimento em até 2h"]
  }, {
    id: "premium" as const,
    name: "Premium",
    price: "298",
    ...
    recommended: false,
    features: ["Tudo do plano Plus", "Atendimento personalizado", "Suporte estratégico", "Planejamento tributário", "Reuniões mensais", "Contador dedicado", "Prioridade máxima"]
  }];
  return <section id="planos" className="py-20 md:py-28 section-alt">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            ...
            <span className="text-highlight">para o seu negócio</span>
          </h2>
        ...
        <div className="grid gap-6 md:grid-cols-3 md:gap-8 max-w-5xl mx-auto">
          {plans.map(plan => <div key={plan.id} className={`plan-card relative ${plan.recommended ? "plan-recommended" : ""}`}>
